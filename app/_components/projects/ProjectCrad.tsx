    ...
    <div className="group relative flex flex-col justify-between h-full rounded-2xl border border-slate-200/50 dark:border-white/5 bg-white/70 dark:bg-white/[0.02] p-6 backdrop-blur-md shadow-sm hover:shadow-[0_20px_40px_rgba(0,0,0,0.03)] dark:hover:shadow-[0_20px_40px_rgba(255,255,255,0.015)] overflow-hidden transition-shadow">
      ...
      <div>
        ...
        <p className="text-sm leading-relaxed text-slate-650 dark:text-gray-400 mb-6 line-clamp-4">
          A professional-grade Single Page Application (SPA) designed for
          businesses and freelancers to track supplier relationships, manage
          invoices, and monitor financial health.
        </p>
      </div>
      ...
      <div className="">
        {/* <div className="flex flex-wrap gap-1.5 mb-6">
          {technologies.map((tech) => (
            <span className="px-2 py-0.5 rounded-md text-xs font-medium border border-slate-150/50 dark:border-white/5 bg-slate-50/50 dark:bg-white/[0.015] text-slate-600 dark:text-gray-300 shadow-tiny font-sans" key={tech}>{tech}</span>
          ))}
        </div> */}
